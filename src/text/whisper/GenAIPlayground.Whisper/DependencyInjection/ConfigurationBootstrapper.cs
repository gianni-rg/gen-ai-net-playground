...
using GenAIPlayground.Whisper.Models.Settings;
...
public static class ConfigurationBootstrapper
{
    ...
    private static IConfiguration BuildConfiguration(string[] args)
    {
        ...
        // Remember to configure variables as "GAIP-WHSP_<section>__<key>" (and restart Visual Studio or Terminal, if open)
        configuration.AddEnvironmentVariables(prefix: "GAIP-WHSP_");
